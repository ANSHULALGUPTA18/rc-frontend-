...
function ChevronRightIcon(): React.ReactElement {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className="h-4 w-4 text-ink-subtle">
  ...
  return (
    <AppShell>
      <div className="max-w-2xl">
        ...
        <p className="mt-1 text-sm text-ink-muted">Manage system configuration and administration.</p>
